            ...
            BottomCardView(show: $showCard)
                ...
                .gesture(
                    DragGesture().onChanged{ value in
                            self.bottomState = value.translation //手指拖动距离
                        if self.showFull { //防止瞬间重置
                    ...
                    .onEnded { value in
                        ...
                        if (self.bottomState.height < -100 && !self.showFull) || (self.bottomState.height < -250
                            && self.showFull) {
                            self.bottomState.height = -300
                            self.showFull = true
                        } else {
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 20.0) {
                RingView(color1: #colorLiteral(red: 0.2588235438, green: 0.7568627596, blue: 0.9686274529, alpha: 1), color2: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), width: 88, heigth: 88, percent: 78, show: $show)
